                ...
                <div class="row">
                    <div class="col-lg-6 col-md-4 col-sm-6">
                        <div class="page_title">
                            <h2>	Programs under <?php  
							              
										 $dataSQL="SELECT `institution_id`, `institution_name`, `institution_country`, `status` FROM `institutions` WHERE `institution_id`=:institution_id";
											$stmt = $conn2->prepare($dataSQL);
										  $stmt->bindParam(":institution_id",$inst_id);
