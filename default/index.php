...
<body>
    ...
    <div id="educo_wrapper">
	   ...
	   <!--header end -->
                            ...
                            <div id="rev_slider" class="rev_slider " data-version="5.0">
                                <ul>
                                    ...
                                    <li data-transition="3dcurtain-horizontal">
                                        ...
                                        <!-- MAIN IMAGE -->
                                        <img src="../assets/images/header/slider_3.jpg" alt="">
                                        ...
                                        <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" data-x="['left','left','left','left']" data-hoffset="['45','60','60','40']" data-y="['top','top','top','top']" data-voffset="['170','175','155','115']" data-width="none" data-height="none"
                                            data-whitespace="nowrap" data-transform_idle="o:1;" data-transform_in="y:[-100%];z:0;rZ:35deg;sX:1;sY:1;skX:0;skY:0;s:2000;e:Power4.easeInOut;" data-transform_out="s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                                            data-mask_in="x:0px;y:0px;s:inherit;e:inherit;" data-start="1510" data-splitin="chars" data-splitout="none" data-responsive_offset="on" data-elementdelay="0.05" style="z-index: 5; white-space: nowrap; font-size: 50px; color:#fff;     font-family: 'Roboto Slab', serif;">We help students reach their life goals
                                        </div>
                                        <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" data-x="['left','left','left','left']" data-hoffset="['45','60','60','40']" data-y="['top','top','top','top']" data-voffset="['230','215','180','170']" data-width="none" data-height="none"
                                            data-whitespace="nowrap" data-transform_idle="o:1;" data-transform_in="y:[100%];z:0;rZ:-35deg;sX:1;sY:1;skX:0;skY:0;s:2000;e:Power4.easeInOut;" data-transform_out="s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                                            data-mask_in="x:0px;y:0px;s:inherit;e:inherit;" data-start="1810" data-splitin="chars" data-splitout="none" data-responsive_offset="on" data-elementdelay="0.05" style="z-index: 5; white-space: nowrap; font-size: 50px; color:#fff;     font-family: 'Roboto Slab', serif;">faster and more efficiently.
                                        </div>
                                    ...
                                    <li data-transition="3dcurtain-vertical">
                                        ...
                                        <!-- MAIN IMAGE -->
                                        <img src="../assets/images/header/slider_4.jpg" alt="">
                                        <div class="ed_course_single_image_overlay"></div>
                                        <!-- LAYER NR. 1 -->
                                        <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" data-x="['left','left','left','left']" data-hoffset="['45','60','60','40']" data-y="['top','top','top','top']" data-voffset="['170','175','155','115']" data-width="none" data-height="none"
                                            data-whitespace="nowrap" data-transform_idle="o:1;" data-transform_in="x:[105%];z:0;rX:45deg;rY:0deg;rZ:90deg;sX:1;sY:1;skX:0;skY:0;s:2000;e:Power4.easeInOut;" data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                                            data-mask_in="x:0px;y:0px;s:inherit;e:inherit;" data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1000" data-splitin="chars" data-splitout="none" data-responsive_offset="on" data-elementdelay="0.05"
        ...
        <div class="ed_transprentbg ed_toppadder100 ed_bottompadder80">
            <div class="container">
                <div class="row">
                    ...
                    <div class="ed_mostrecomeded_course_slider row justify-content-center">
					<?php  
							
										 $dataSQL="SELECT `course_id`, `course_name`, `course_category`, `course _subcategory`, 
										 `course_price`, `instituion_id`, `program_id`, `course_decription`, `course_status`, `teacher_id`,`course_image` FROM `course` ";
            ...
            ?>
                            ...
                            <div class="ed_mostrecomeded_course">
                                <div class="ed_item_img">
                                    <img src="<?php echo $row['course_image']; ?>" alt="item1" class="img-responsive">
                                </div>
                                <div class="ed_item_description ed_most_recomended_data">
                                    <h4><a href="course_single.html"><?php echo $row['course_name'];?></a><span>$ <?php echo $row['course_price'];?></span></h4>
                                    <div class="row">
                                        <div class="ed_rating">
                                    ...
                                    <a href="course_single.php?c_id=<?php echo $row['course_id']; ?>" class="ed_getinvolved">get involved <i class="fa fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ed_counter_wrapper row">
                            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="ed_counter">
                                    ...
                                    <h4>Graduate and Get Certification</h4>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="ed_counter">
                                    ...
                                    <h4>We assign a tutor to help you</h4>
                                    <p>Get an assigned Tutor to help you..</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="ed_counter">
        ...
        <div class="ed_transprentbg ed_toppadder80 ed_bottompadder80">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="ed_latest_newsslider row">
                            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="ed_latestnews">
                                    ...
                                    <a href="javascript:void(0);">read more <i class="fa fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="ed_latestnews">
